    ...
    <>
      ...
      <Section className="bg-surface/30 !py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            { src: "/images/raffaele-2.jpg", alt: "Raffaele Sollecito" },
            { src: "/images/raffaele-3.jpg", alt: "Raffaele Sollecito — interview" },
            { src: "/images/raffaele-4.jpg", alt: "Raffaele Sollecito" },
          ].map((photo) => (

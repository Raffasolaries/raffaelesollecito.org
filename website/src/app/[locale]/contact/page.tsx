      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent/10 rounded-full">
            ...
            <span className="text-sm text-accent">{t("availability")}</span>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a
                href="mailto:raffaele.sollecito@aspectsolutions.eu"
                className="text-foreground hover:text-accent transition-colors"
              >
                raffaele.sollecito@aspectsolutions.eu
              </a>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a href="tel:+39335422409" className="text-foreground hover:text-accent transition-colors">
                +39 335 422 409
              </a>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-foreground">{t("location_value")}</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted">linkedin.com/in/raffasolaries</p>
              </div>
            </a>

            <a
              href="https://github.com/Raffasolaries"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-3 rounded-md hover:bg-surface-light transition-colors group"
            >
              ...
              <div>
                <p className="font-medium group-hover:text-accent transition-colors">GitHub</p>
                <p className="text-sm text-muted">github.com/Raffasolaries</p>
              </div>
            </a>

            <a
              href="https://raffaelesollecito.org"
              className="flex items-center gap-4 p-3 rounded-md hover:bg-surface-light transition-colors group"
            >
              ...
              <div>
                <p className="font-medium group-hover:text-accent transition-colors">Website</p>
                <p className="text-sm text-muted">raffaelesollecito.org</p>
              </div>
            </a>
          </div>
        </div>

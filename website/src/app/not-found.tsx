...
/** Root 404 (served by CloudFront custom_error_response for 403/404). Bilingual, self-contained. */
    ...
    <html lang="en" className="dark">
      <body className="font-sans antialiased bg-background text-foreground min-h-screen flex items-center justify-center px-6">
        <main className="max-w-lg text-center">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight">Page not found · Pagina non trovata</h1>
